...
$userData = fetchAPI('https://dummyjson.com/users?limit=30');
...
if ($selected_user_id) {
    ...
    $cartData = fetchAPI('https://dummyjson.com/carts?limit=30');
        ...
        <?php if ($selected_user && $selected_user_id): ?>
            <div>
                <div class="cart-header">
                    ...
                    <a href="carts.php" class="back-btn">
                        Back to Users
                    </a>
                </div>
                            ...
                            <div class="user-card">
                                ...
                                <div class="user-info">
                                    ...
                                    <div style="margin-top:10px;">
                                        <a href="carts.php?user_id=<?= $uid ?>" class="btn btn-purple btn-sm">🛒 View Cart</a>
                                    </div>
                                </div>
                            </div>
                        </div>
